...
function util::version_ldflags() {
  ...
  LDFLAGS="-X github.com/puller-io/puller/pkg/version.gitVersion=${GIT_VERSION} \
                        -X github.com/puller-io/puller/pkg/version.gitCommit=${GIT_COMMIT_HASH} \
                        -X github.com/puller-io/puller/pkg/version.gitTreeState=${GIT_TREESTATE} \
                        -X github.com/puller-io/puller/pkg/version.buildDate=${BUILDDATE}"
  echo $LDFLAGS
}
